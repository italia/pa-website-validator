...
export const schoolInformativeAuditsFolder = auditsFolder + "/school/informative"
export const commonInformativeAuditsFolder = auditsFolder + "/common/informative"
export const municipalityInformativeAuditsFolder = auditsFolder + "/municipality/informative"
