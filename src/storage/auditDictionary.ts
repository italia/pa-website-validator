export const auditDictionary = {
  ...
  "school-ux-ui-consistency-bootstrap-italia-double-check": {
    ...
    failureTitle:
      "C.SC.1.2 - LIBRERIA DI ELEMENTI DI INTERFACCIA - Il sito della scuola deve utilizzare la libreria Bootstrap Italia in una versione più recente di 1.6.",
    description:
      "CONDIZIONI DI SUCCESSO: almeno il 50% delle classi CSS usate in ogni pagina appartiene alla libreria Bootstrap Italia e questa è presente e in uso in una versione uguale o superiore alla 2.0; MODALITÀ DI VERIFICA: in ogni pagina analizzata viene verificata la presenza della libreria Bootstrap Italia e la versione in uso, individuando la proprietà CSS --bootstrap-italia-version all’interno del selettore :root o la variabile globale window.BOOTSTRAP_ITALIA_VERSION. Inoltre almeno il 50% delle classi CSS uniche trovate nella pagina deve appartenere all'elenco delle classi CSS di Bootstrap Italia; RIFERIMENTI TECNICI E NORMATIVI: [Documentazione del Modello scuole](https://docs.italia.it/italia/designers-italia/design-scuole-docs/it/versione-corrente/index.html), [Documentazione delle App di valutazione](https://docs.italia.it/italia/designers-italia/design-scuole-docs/it/versione-corrente/index.html).",
  },
