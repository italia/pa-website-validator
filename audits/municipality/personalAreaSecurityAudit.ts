...
class LoadAudit extends Audit {
  ...
  static async audit(
    ...
    const origin = 'http://wp-scuole.local/design-comuni-pagine-statiche/new-templates/dist/template-homepage.html' //artifacts.origin;
    ...
    if (
      ...
      if (Boolean(elementObj) && ("href" in elementObj) && elementObj.href && elementObj.href !== "#" && elementObj.href !== "") {
      ...
      if ((await isInternalUrl(elementObj.href)) && !elementObj.href.includes(origin)) {
