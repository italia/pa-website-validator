...
class LoadAudit extends Audit {
  static get meta() {
    return {
      ...
      failureTitle:
        "La versione del tema wordpress non è allineata alla più recente",
  ...
  static async audit(
    ...
    const headings = [
      {
        key: "current_theme_manifest",
        itemType: "text",
        text: "Versione corrente del tema",
      },
      {
        key: "theme_version_required",
        itemType: "text",
        text: "Versione del tema richiesta",
      },
      {
        key: "checked_element",
        itemType: "text",
